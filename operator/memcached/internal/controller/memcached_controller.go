...
import (
	...
	"cicd.operator/memcached/api/v1alpha1"
...
// +kubebuilder:rbac:groups=cache.cicd.operator,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.cicd.operator,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.cicd.operator,resources=memcacheds/finalizers,verbs=update
...
func (r *MemcachedReconciler) deploymentForMemcached(memcached *v1alpha1.Memcached) (*appsv1.Deployment, error) {
	...
	// More info: https://kubernetes.i o/docs/concepts/overview/working-with-objects/owners-dependents/
